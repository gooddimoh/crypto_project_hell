    ...
    <div id="tab-game-american-roulette" class="collapse">
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="GAME_AMERICAN_ROULETTE_CATEGORIES" class="form-control" value="{{ config('game-american-roulette.categories') }}">
                <small>{{ __('Comma-delimited list') }}</small>
            </div>
            <file-upload
                label="{{ __('Banner') }}"
                path="{{ config('game-american-roulette.banner') }}"
