<div class="<?php echo e(config('settings.layout') == 'boxed' ? 'container' : 'container-fluid'); ?> px-0">
    <nav class="navbar navbar-expand-md navbar-dark">
        <a class="navbar-brand text-body" href="<?php echo e(route('backend.dashboard.index')); ?>">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar">
            <div class="navbar-nav dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar-dropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('backend.transactions.index')); ?>"><?php echo e(__('Transactions')); ?></a>
