...
<?php $__env->startSection('content'); ?>
    <div class="btn-group mb-4" role="group" aria-label="<?php echo e(__('All games')); ?>">
        ...
        <?php elseif(Request::get('game') == 'HorseRacing'): ?>
            <a href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['HorseRacing' => 'Keno']))); ?>" class="btn btn-primary"><?php echo e(__('Horse Racing')); ?></a>
        <?php else: ?>
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="<?php echo e(route('frontend.leaderboard', array_merge(request()->query(), ['game' => 'HorseRacing']))); ?>">
                <?php echo e(__('Horse Racing')); ?>
