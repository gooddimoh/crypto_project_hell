...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        ...
        <tr>
            ...
            <?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.tables.sortable-column', ['id' => 'total_bet', 'sort' => $sort, 'order' => $order]); ?>
                <?php echo e(__('Bet')); ?>
        ...
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td data-title="<?php echo e(__('Name')); ?>">
                    ...
                    <?php if($user->profiles): ?>
                        <?php $__currentLoopData = $user->profiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span data-balloon="<?php echo e(__('Linked :provider profile', ['provider' => ucfirst($profile->provider_name)])); ?>" data-balloon-pos="up">
                                <i class="<?php echo e(config('services.login_providers.' . $profile->provider_name . '.icon')); ?>"></i>
                            </span>
                ...
                <td data-title="<?php echo e(__('Bet')); ?>"><?php echo e($user->_total_bet); ?></td>
                    ...
                    <div class="btn-group" role="group" aria-label="<?php echo e(__('Edit')); ?>">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="users-action-button">
                                ...
                                <?php if($user->role != App\Models\User::ROLE_BOT): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('backend.users.mail.show', array_merge(['user' => $user], request()->query()))); ?>">
