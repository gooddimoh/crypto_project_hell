...
<body class="<?php echo e(str_replace('.','-',Route::currentRouteName())); ?> theme-<?php echo e(config('settings.theme')); ?>" onload="if(window !== window.top) window.top.location = window.location">
