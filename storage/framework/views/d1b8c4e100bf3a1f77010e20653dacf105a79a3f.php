...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('installed', 'game-horse-racing')): ?>
        <h2 class="mt-4"><?php echo e(__('Horse Racing')); ?></h2>
        <?php echo $__env->make('game-horse-racing::frontend.pages.verify-description', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
