...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('backend.users.update', array_merge(['user' => $user], request()->query()))); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group referral-bonus-field <?php echo e(old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden'); ?>">
            ...
            <div class="input-group">
                <input type="text" name="referee_sign_up_credits" class="form-control <?php echo e($errors->has('referee_sign_up_credits') ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(config('settings.bonuses.referral.referee_sign_up_credits')); ?>" value="<?php echo e(old('referee_sign_up_credits', $user->referee_sign_up_credits)); ?>">
        ...
        <div class="form-group referral-bonus-field <?php echo e(old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden'); ?>">
            ...
            <div class="input-group">
                <input type="text" name="referrer_sign_up_credits" class="form-control <?php echo e($errors->has('referrer_sign_up_credits') ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(config('settings.bonuses.referral.referrer_sign_up_credits')); ?>" value="<?php echo e(old('referrer_sign_up_credits', $user->referrer_sign_up_credits)); ?>">
                <div class="input-group-append">
                    <span class="input-group-text"><?php echo e(__('credits')); ?></span>
                </div>
            </div>
        ...
        <div class="form-group referral-bonus-field <?php echo e(old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden'); ?>">
            ...
            <div class="input-group">
                <input type="text" name="referrer_game_loss_pct" class="form-control <?php echo e($errors->has('referrer_game_loss_pct') ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(config('settings.bonuses.referral.referrer_game_loss_pct')); ?>" value="<?php echo e(old('referrer_game_loss_pct', $user->referrer_game_loss_pct)); ?>">
                <div class="input-group-append">
        ...
        <div class="form-group referral-bonus-field <?php echo e(old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden'); ?>">
            ...
            <div class="input-group">
                <input type="text" name="referrer_game_win_pct" class="form-control <?php echo e($errors->has('referrer_game_win_pct') ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(config('settings.bonuses.referral.referrer_game_win_pct')); ?>" value="<?php echo e(old('referrer_game_win_pct', $user->referrer_game_win_pct)); ?>">
                <div class="input-group-append">
                    <span class="input-group-text">%</span>
                </div>
            </div>
        ...
        <div class="form-group referral-bonus-field <?php echo e(old('individual_referral_bonuses', $user->has_individual_referral_bonuses) ? '' : 'hidden'); ?>">
            ...
            <div class="input-group">
                <input type="text" name="referrer_deposit_pct" class="form-control <?php echo e($errors->has('referrer_deposit_pct') ? 'is-invalid' : ''); ?>" placeholder="<?php echo e(config('settings.bonuses.referral.referrer_deposit_pct')); ?>" value="<?php echo e(old('referrer_deposit_pct', $user->referrer_deposit_pct)); ?>">
                <div class="input-group-append">
                    <span class="input-group-text">%</span>
                </div>
            </div>
